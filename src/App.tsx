...
export default function App() {
  return (
    <Routes>
      ...
      <Route path="/journey/portfolio" element={<Portfolio />} />
      <Route path="/journey/risk" element={<RiskTolerance />} />
      <Route path="/journey/objectives" element={<Objectives />} />
      <Route path="/journey/timeline" element={<Timeline />} />
    </Routes>
  );
}